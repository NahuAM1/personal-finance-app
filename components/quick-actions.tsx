...
import { PlusCircle, TrendingUp, CreditCard, PiggyBank, MapPin, DollarSign } from "lucide-react"
            ...
            {actions.map((action) => {
              ...
              return (
                <Button
                  ...
                  onClick={() => {
                    // Simular navegación a la pestaña correspondiente
                    const tabTrigger = document.querySelector(`[value="${action.href.slice(1)}"]`) as HTMLElement
                    if (tabTrigger) {
                      tabTrigger.click()
                    }
                  }}
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-gray-600">Balance del Mes</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-gray-600">Meta de Ahorro</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-purple-600">Alimentación</div>
